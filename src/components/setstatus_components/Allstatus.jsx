...
function Allstatus() {
  ...
  return (
    <div style={{ height: "100%",minHeight:"600px" }}>
      ...
      <div className="w-full md:w-3/6 flex justify-between mb-2 mx-auto">
        <div className="p-3 bg-white rounded-lg shadow-sm w-4/6 mr-4">
        ...
        <button
          onClick={showModal}
          className=" text-center py-2 px-5 rounded-lg shadow-lg bg-purple-500 hover:bg-purple-700 text-white text-lg"
        >
